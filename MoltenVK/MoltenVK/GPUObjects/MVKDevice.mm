...
MVKArrayRef<MVKAccelerationStructure*> MVKDevice::getBlasRegistryCPU()
{
	return MVKArrayRef<MVKAccelerationStructure*>(_blasRegistryCPU.data(), _blasRegistryCPU.size());
}
